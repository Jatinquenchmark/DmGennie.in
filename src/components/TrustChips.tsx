        ...
        <span
          ...
          className={
            isDark
              ...
              : 'inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/70 px-4 py-2 text-sm font-bold text-[#6f6570] shadow-[0_12px_30px_rgba(109,41,72,0.08)] backdrop-blur-xl'
          }
        >
          <span
            className={
              isDark
                ...
                : 'flex h-5 w-5 items-center justify-center rounded-full bg-[#6d2948]/10 text-[#6d2948]'
            }
          >
