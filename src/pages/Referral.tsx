...
export default function Referral() {
  ...
  return (
    <div className="min-h-screen bg-[#fbf7f8] text-[#151119]">
      <header className="sticky top-0 z-50 border-b border-white/70 bg-white/72 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8 lg:px-12">
          ...
          <nav className="hidden items-center gap-8 text-sm font-bold text-[#6a6168] md:flex">
            <Link to="/pricing" className="transition-colors hover:text-[#6d2948]">Pricing</Link>
            <a href="#how-referrals-work" className="transition-colors hover:text-[#6d2948]">How it Works</a>
            <Link to="/referral" className="text-[#6d2948]">Affiliate</Link>
          </nav>
          <Link to="/signup" className="rounded-xl bg-[#6d2948] px-5 py-2.5 text-sm font-black text-white shadow-[0_12px_28px_rgba(109,41,72,0.22)] transition-colors hover:bg-[#551f38]">
            Join Program
          </Link>
        </div>
      </header>
      ...
      <main>
        <section className="relative overflow-hidden px-6 pb-20 pt-16 sm:px-8 sm:pb-24 sm:pt-20 lg:px-12">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_22%_12%,rgba(109,41,72,0.14),transparent_30%),radial-gradient(circle_at_80%_32%,rgba(200,154,111,0.12),transparent_30%),linear-gradient(180deg,#fff,rgba(248,241,243,0.78))]" />
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.78fr_1.1fr]">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/70 px-4 py-2 text-sm font-black uppercase tracking-[0.16em] text-[#6d2948] shadow-sm backdrop-blur">
            ...
            <div className="relative">
              <div className="absolute -inset-6 rounded-[2.5rem] bg-[#6d2948]/10 blur-2xl" />
              <div className="relative overflow-hidden rounded-[2.1rem] border border-white/80 bg-white/78 shadow-[0_30px_90px_rgba(109,41,72,0.16)] backdrop-blur-xl">
                ...
                <div className="absolute left-5 top-5 inline-flex items-center gap-3 rounded-2xl border border-white/55 bg-white/78 px-4 py-3 shadow-[0_16px_40px_rgba(109,41,72,0.16)] backdrop-blur">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[linear-gradient(155deg,#351326,#6d2948)]">
          ...
          <div className="relative mx-auto mt-10 max-w-7xl">
            <div className="grid gap-6 rounded-[2rem] border border-white/80 bg-white/72 p-5 shadow-[0_28px_80px_rgba(109,41,72,0.12)] backdrop-blur-xl lg:grid-cols-[0.9fr_1.1fr] lg:p-7">
              <div className="rounded-[1.6rem] bg-[linear-gradient(155deg,#351326_0%,#6d2948_58%,#93536a_100%)] p-7 text-white shadow-[0_22px_64px_rgba(109,41,72,0.24)]">
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 p-4">
                  ...
                  <div className="truncate rounded-xl bg-white px-4 py-3 text-sm font-black text-[#6d2948]">
                    dmgennie.in/ref/partner
                  </div>
                </div>
              </div>

              <div className="rounded-[1.6rem] border border-[#eadde2] bg-[#fbf7f8] p-6">
                <div className="mb-5 flex items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 text-sm font-black uppercase tracking-[0.16em] text-[#6d2948]">
                ...
                <input
                  ...
                  className="mb-6 h-2 w-full cursor-pointer accent-[#6d2948]"
                    ...
                    <button
                      ...
                      className={`flex items-center justify-between rounded-2xl border px-4 py-4 text-left shadow-sm transition-all ${
                        referralCount === Number(item.creators)
                          ? 'border-[#6d2948]/25 bg-white shadow-[0_12px_28px_rgba(109,41,72,0.10)]'
                          : 'border-white/80 bg-white/70 hover:border-[#6d2948]/20 hover:bg-white'
                      }`}
                    >
                      <div>
        ...
        <section id="how-referrals-work" className="bg-white px-6 py-20 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              <div className="mb-4 text-sm font-black uppercase tracking-[0.18em] text-[#6d2948]">How It Works</div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {steps.map((step, index) => {
                ...
                return (
                  <div key={step.title} className="rounded-[1.5rem] border border-[#eadde2] bg-[#fbf7f8] p-7 shadow-[0_18px_45px_rgba(109,41,72,0.08)]">
                    <div className="mb-6 flex items-center justify-between">
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#6d2948] text-white">
        ...
        <section className="relative overflow-hidden px-6 py-20 sm:px-8 lg:px-12">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_30%,rgba(109,41,72,0.10),transparent_28%),radial-gradient(circle_at_78%_30%,rgba(200,154,111,0.10),transparent_28%)]" />
          <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1fr]">
            <div>
              <div className="mb-4 text-sm font-black uppercase tracking-[0.18em] text-[#6d2948]">Why Partners Like It</div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {perks.map((perk) => (
                <div key={perk} className="flex items-center gap-3 rounded-2xl border border-white/80 bg-white/72 p-4 shadow-sm backdrop-blur">
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#6d2948] text-white">
        ...
        <section className="relative overflow-hidden px-6 py-20 sm:px-8 lg:px-12">
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.4),rgba(248,241,243,0.95)),radial-gradient(circle_at_50%_40%,rgba(109,41,72,0.12),transparent_32%)]" />
          <div className="relative mx-auto max-w-6xl rounded-[2.25rem] border border-white/80 bg-white/72 p-7 shadow-[0_34px_100px_rgba(109,41,72,0.14)] backdrop-blur-xl sm:p-10 lg:p-12">
            <div className="grid items-center gap-8 lg:grid-cols-[0.82fr_1fr]">
              <div className="relative overflow-hidden rounded-[1.75rem] bg-[linear-gradient(155deg,#351326_0%,#6d2948_58%,#93536a_100%)] p-8 text-white shadow-[0_22px_64px_rgba(109,41,72,0.24)]">
              ...
              <div>
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  {['Fast approval', 'Monthly payouts', 'Creator-friendly offer'].map((item) => (
                    <span key={item} className="rounded-full border border-[#eadde2] bg-[#fbf7f8] px-4 py-2 text-sm font-black text-[#6d2948]">
                      {item}
                    </span>
                  ))}
                </div>
                <div className="mt-8 flex flex-wrap gap-4">
                  <Link to="/signup" className="rounded-xl bg-[#6d2948] px-7 py-4 text-base font-black text-white shadow-[0_16px_36px_rgba(109,41,72,0.22)] transition-all hover:-translate-y-0.5 hover:bg-[#551f38]">
                    Apply Now
                  </Link>
                  <a href="mailto:support@dmgennie.in" className="inline-flex items-center gap-2 rounded-xl border border-[#eadde2] bg-white px-7 py-4 text-base font-black text-[#151119] shadow-sm transition-all hover:-translate-y-0.5 hover:border-[#6d2948]/30">
                    <Mail className="h-4 w-4 text-[#6d2948]" />
                    Contact Us
                  </a>
                </div>
              </div>
