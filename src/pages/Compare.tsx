...
function StatusBadge({ value }: { value: Status }) {
  ...
  return <span className="text-sm font-bold text-muted-foreground">{value}</span>
}
              ...
              <div className="divide-y divide-border">
                ...
                {page.rows.map((row) => (
                  <div key={row.feature} className="grid grid-cols-[1.2fr_1fr_1fr] items-center">
                    <div className="px-7 py-5 text-base font-bold text-foreground">{row.feature}</div>
                    <div className="border-x border-border px-7 py-5 text-center">
